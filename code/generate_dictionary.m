...
num_patches = (floor((img_width-patchsize)/stride)+1)*(floor((img_height-patchsize)/stride)+1);
...
for vid_seg_index= 1:n_videos
    ...
    for i = 1:stride:img_width-patchsize+1
        for j = 1:stride:img_height-patchsize+1
